<%-- 
    ...
    Created on : Jan 15, 2020, 5:31:43 PM
    Author     : root
--%>
...
if(request.getParameter("action").equals("signin"))
{
    ...
    if(result.next())
    {
        ...
        //redirect url
        %>
        <script> window.location.href="http://localhost:8080/ibm/admin/execute.jsp?request=dashboard";</script>
        <%
    }
    else
    {
        ...
        <script>
            ...
            window.location.href="http://localhost:8080/ibm/admin/index.jsp";
        </script>
      <%  
    }
}
