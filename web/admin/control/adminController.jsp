...
if(request.getParameter("validate").equals("Register"))
{
    ...
    %>
        <script>window.location.href="http://localhost:8080/ibm/admin/execute.jsp?request=list_admin"; </script>
      <%  
    }
    else 
    { 
      ...
      %>
        <script>window.location.href="http://localhost:8080/ibm/admin/execute.jsp?request=new_admin";</script>
      <%  
    } 
}
//Update 
...
else if(request.getParameter("validate").equals("Save"))
{
    ...
    { 
      ...
      %>
        <script>window.location.href="http://localhost:8080/ibm/admin/execute.jsp?request=settings"; </script>
      <%  
    }
    else 
    { 
