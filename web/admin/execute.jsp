        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>IBM Training MIS</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="execute.jsp?request=training_mentor"><i class="fa fa-users"></i> Training Mentors </a>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Training <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="execute.jsp?request=training_course">Training Course</a></li>
                      <li><a href="execute.jsp?request=training_program">Training Program</a></li>
                    </ul>
                  </li>
                  <li><a href="execute.jsp?request=training_participant"><i class="fa fa-users"></i> Participants <span class=""></span></a>
                  </li>
                  <li><a href="execute.jsp?request=settings"><i class="fa fa-cogs"></i> Settings </a>
                  </li>
...
<!--                    <li>
        ...
        <%}%>
        <% if(request.getParameter("request").equals("training_course")){%>
        <jsp:include page="views/training_course.jsp"/>
        <%}%>
        <% if(request.getParameter("request").equals("training_program")){%>
        <jsp:include page="views/training_program.jsp"/>
        <%}%>
        <% if(request.getParameter("request").equals("training_mentor")){%>
        <jsp:include page="views/training_mentor.jsp"/>
        <%}%>
        <% if(request.getParameter("request").equals("settings")){%>
        <jsp:include page="views/settings.jsp"/>
        <%}%>
        <% if(request.getParameter("request").equals("training_participant")){%>
        <jsp:include page="views/training_participant.jsp"/>
        <%}%>
        <!--End Links Control-->
        ...
        <footer>
          <div class="pull-right">
            IBM Online Training MIS - developed  by <a href="mailto:ezechielkalengya@gmail.com">ezechielkalengya@gmail.com</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
